...
cp -r test/elrond_2shard_4node/* $TM_HOME
...
./build/elrond -home $TM_HOME/shard0/node2 -leader "false" -shards 2 -shardid 0 -inport 10057 -outport "20057,21057" &> $LOG_DIR/shard0node2.log &
./build/elrond -home $TM_HOME/shard0/node3 -leader "false" -shards 2 -shardid 0 -inport 10057 -outport "20057,21057" &> $LOG_DIR/shard0node3.log &
...
./build/elrond -home $TM_HOME/shard1/node2 -leader "false" -shards 2 -shardid 1 -inport 10057 -outport "20057,21057" &> $LOG_DIR/shard1node2.log &
./build/elrond -home $TM_HOME/shard1/node3 -leader "false" -shards 2 -shardid 1 -inport 10057 -outport "20057,21057" &> $LOG_DIR/shard1node3.log &
