...
func main() {
	...
	request1 := "127.0.0.1:10057/broadcast_tx_commit?tx=\"fromid=0,toid=1,type=1,from=ABCD,to=DCBA,value=20,data=NONE,nonce=1\""
	...
	request2 := "127.0.0.1:10057/broadcast_tx_commit?tx=\"fromid=1,toid=0,type=1,from=EFGH,to=WXYZ,value=20,data=NONE,nonce=1\""
